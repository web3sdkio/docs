...
The document is written for technical and non-technical readers. To ask further questions about web3sdkio’s `Pack` contract, please join the [web3sdkio discord](https://discord.gg/web3sdkio) or create a github issue.
