...
<p>
Use the <a href="https://docs.web3sdk.io/cli">CLI</a>,
to publish a new version of your smart contract to our{" "}
on-chain registry,
where anyone can view and deploy it from the <a href="https://web3sdk.io/explore">explore page</a>.
...
Releasing your contract on web3sdkio is the best way to get your protocol in front of 60k+ web3 developers.
...
2. Run `npx web3sdkio@latest release` from your project
