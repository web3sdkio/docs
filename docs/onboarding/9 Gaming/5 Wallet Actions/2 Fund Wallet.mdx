...
<div className="row" style={{ marginBottom: 12 }}>
  <div className="col col--12" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/set-up-coinbase-pay-in-your-unity-project/"
...
![Coinbase Pay Flow](https://blog.web3sdk.io/content/images/2022/12/ezgif-2-57be566b6c.gif)
