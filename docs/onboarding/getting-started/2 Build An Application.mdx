...
Inside the [`_app.jsx`](https://github.com/web3sdkio-example/next-javascript-starter/blob/main/pages/_app.js#L8-L10) file,
...
On the [`index.jsx`](https://github.com/web3sdkio-example/next-javascript-starter/blob/main/pages/index.js#L5) page,
