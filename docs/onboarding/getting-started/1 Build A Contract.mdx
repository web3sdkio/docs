...
```bash
npx web3sdkio@latest create --contract
```
...
the [ERC721Base.sol](https://github.com/web3sdkio/contracts/blob/main/contracts/base/ERC721Base.sol) contract; which
implements the [ERC721A](https://github.com/web3sdkio/contracts/blob/main/contracts/eip/ERC721A.sol) standard with several useful [extensions](/contractkit/extensions).
...
- Opens the [dashboard](/dashboard) for you to select one of our
  [supported networks](https://blog.web3sdk.io/guides/which-network-should-you-use/) to deploy to

![web3sdkio CLI - web3sdkio deploy](./assets/2.png)
...
Finally, select the [network](https://blog.web3sdk.io/guides/which-network-should-you-use/)
you want to deploy to _(we recommend the Goerli test network)_, and click "Deploy Now".

![Deploying your contract using the web3sdkio dashboard](./assets/3.png)
...
From the [explore page](https://web3sdk.io/explore), you can choose from
a curated collection of gas-optimized, audited, and
battle-tested smart contracts built by trusted open-source protocols and the web3sdkio team;
ready to deploy in one click.

For example, let's select the [NFT Collection](https://web3sdk.io/web3sdkio.eth/TokenERC721)
smart contract built by the web3sdkio team:

![discover smart contracts on explore page](./assets/18.png)

From this page, we can discover the contract's features,
view its source code, see which [extensions](https://portal.web3sdk.io/contractkit/extensions) it implements,
and deploy it to the [blockchain of our choice](https://blog.web3sdk.io/guides/which-network-should-you-use/).
...
Finally, select the [network](https://blog.web3sdk.io/guides/which-network-should-you-use/) you want to deploy your
