...
![web3sdkio CLI select base contract](./assets/1.png)
...
the [ERC721Base.sol](https://github.com/web3sdkio/contracts/blob/main/contracts/base/ERC721Base.sol) contract.
...
- Opens the [dashboard](/dashboard) for you to select one of our [supported networks](https://blog.web3sdk.io/guides/which-network-should-you-use/) to deploy to.
...
![web3sdkio dashboard contract deployed state](./assets/8.png)
...
<TwitterCard
  text={`I just deployed an NFT smart contract with Solidity & @web3sdkio 🚀 Check it out here: <share your dashboard url to the world!>`}
/>
