...
After you release your contract, you'll have a landing page for it on the web3sdkio website.
...
![web3sdkio release landing page](./assets/16.png)
...
it is automatically detected and set as your [profile's URL](https://web3sdk.io/jarrodwatts.eth); giving you an easy way to verify your identity and prove ownership of your contracts.

![web3sdkio release profile page](./assets/17.png)
...
<TwitterCard
  text={`I just uploaded my contract to @web3sdkio's on-chain smart contract registry 🔥 Check out my contract <share your release url to the world!>`}
/>
