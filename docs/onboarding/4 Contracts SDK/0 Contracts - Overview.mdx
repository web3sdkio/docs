...
```bash
npm install @web3sdkio/contracts
```
...
<div className="row" style={{ marginBottom: 24 }}>
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/get-started-with-the-contracts-sdk/"
      image="/assets/icons/education.png"
    />
  </div>
  <div className="col col--6" style={{ padding: 8 }}>
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/create-a-generative-art-nft-collection-using-solidity-javascript/"
      image="/assets/icons/education.png"
    />
  </div>
</div>
...
import "@web3sdkio/contracts/base/ERC721Base.sol";
import "@web3sdkio/contracts/extension/Permissions.sol";
