...
```solidity
import "@web3sdkio/contracts/extension/SignatureMintERC1155.sol";
```
...
<ViewContractCodeButton
  link="https://github.com/web3sdkio/contracts/blob/main/contracts/extension/SignatureMintERC1155.sol"
