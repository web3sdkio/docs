...
```solidity
import "@web3sdkio/contracts/extension/DelayedReveal.sol";
```
...
`DelayedReveal` uses the [`LazyMint`](/contractkit/extension-contracts/lazymint) extension. When first lazy minting tokens, you can encrypt the metadata of NFTs and can reveal this metadata once your lazy minted NFTs have been distributed. You can learn more about how delayed reveal NFTs work, in this [blogpost](https://blog.web3sdk.io/delayed-reveal-nfts).

<ViewContractCodeButton
  link="https://github.com/web3sdkio/contracts/blob/main/contracts/extension/DelayedReveal.sol"
  name="DelayedReveal"
/>
...
- Learn more about the usage of this function in this [blogpost](https://blog.web3sdk.io/delayed-reveal-nfts).
