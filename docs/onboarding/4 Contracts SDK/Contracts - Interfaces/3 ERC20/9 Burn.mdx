...
<ViewContractCodeButton
  link="https://github.com/web3sdkio/contracts/blob/main/contracts/extension/interface/IBurnableERC20.sol"
  name="ERC20"
  isInterface={true}
/>
...
import "@web3sdkio/contracts/extension/interface/IBurnableERC20.sol";
