...
<div className="deployContractBtnContainer" style={{ marginTop: -70 }}>
  <DeployThisContractButton
    link={"https://web3sdk.io/contracts/new/pre-built/drop/token-drop"}
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/claim-erc20-token-nextjs"
  ...
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="https://github.com/web3sdkio-template/token-drop"
      image="/assets/icons/education.png"
    />
  </div>
</div>
...
This page outlines how you can create and configure your token drop contract using the [dashboard](https://web3sdk.io/dashboard).
...
<div style={{ width: "fit-content" }}>
  <DeployThisContractButton
    link={"https://web3sdk.io/contracts/new/pre-built/token/token-drop"}
    contractType="token-drop"
  />
</div>
