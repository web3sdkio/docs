...
<div className="deployContractBtnContainer" style={{ marginTop: -70 }}>
  <DeployThisContractButton
    link={
      "https://web3sdk.io/contracts/new/pre-built/marketplace/marketplace"
    }
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="https://portal.web3sdk.io/guides/nft-marketplace-with-typescript-next"
  ...
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="https://portal.web3sdk.io/guides/auction-button-react"
      image="/assets/icons/education.png"
    />
  </div>
</div>
...
This page outlines how you can create and configure your marketplace contract using the [dashboard](https://web3sdk.io/dashboard).
