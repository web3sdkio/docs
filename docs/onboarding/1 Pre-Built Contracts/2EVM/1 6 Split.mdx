...
<div className="deployContractBtnContainer" style={{ marginTop: -70 }}>
  <DeployThisContractButton
    link={"https://web3sdk.io/contracts/new/pre-built/governance/split"}
    contractType="split"
  />
</div>
...
<div className="row" style={{ marginBottom: 24 }}>
  ...
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/nft-drop-with-revenue-share"
      image="/assets/icons/education.png"
    />
  </div>
</div>
...
This page outlines how you can create and configure your split contract using the [dashboard](https://web3sdk.io/dashboard).
