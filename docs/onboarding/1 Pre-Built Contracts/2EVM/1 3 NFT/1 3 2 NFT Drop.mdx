...
<div className="deployContractBtnContainer" style={{ marginTop: -70 }}>
  <DeployThisContractButton
    link={"https://web3sdk.io/contracts/new/pre-built/drop/nft-drop"}
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/create-nft-drop-with-claim-phases"
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/nft-drop-with-delayed-reveal"
      image="/assets/icons/education.png"
    />
  </div>
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/how-to-create-and-setup-a-claimable-nft-drop-on-optimism/"
      image="/assets/icons/education.png"
    />
  </div>
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/how-to-sell-nfts-in-a-custom-erc20-token/"
      image="/assets/icons/education.png"
    />
  </div>
</div>
...
This page outlines how you can create and configure your NFT drop contract using the [dashboard](https://web3sdk.io/dashboard).
...
<div style={{ width: "fit-content" }}>
  <DeployThisContractButton
    link={"https://web3sdk.io/contracts/new/pre-built/token/nft-drop"}
    contractType="nft-drop"
  />
</div>
