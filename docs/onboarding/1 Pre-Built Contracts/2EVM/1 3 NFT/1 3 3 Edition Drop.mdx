...
<div className="deployContractBtnContainer" style={{ marginTop: -70 }}>
  <DeployThisContractButton
    link={"https://web3sdk.io/contracts/new/pre-built/drop/edition-drop"}
...
- Create NFT Memberships such as our [Early Access Cards](https://opensea.io/collection/web3sdkio-community) that you want your users to claim
...
<div className="row" style={{ marginBottom: 24 }}>
  ...
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/early-access-nft-with-typescript"
      image="/assets/icons/education.png"
    />
  </div>
</div>
...
This page outlines how you can create and configure your edition drop contract using the [dashboard](https://web3sdk.io/dashboard).
...
<div style={{ width: "fit-content" }}>
  <DeployThisContractButton
    link={"https://web3sdk.io/contracts/new/pre-built/token/edition-drop"}
    contractType="edition-drop"
  />
</div>
...
You can download our example [CSV File](https://web3sdk.io/airdrop.csv) to get started.
