...
<div className="row" style={{ marginTop: 24 }}>
  <div className="col col--12">
    <QuickstartCard
      ...
      description="Implement web3sdkio Auth with Supabase"
...
First, we need to install the `@web3sdkio/auth` and `@supabase/supabase-js` packages as follows:

```bash npm2yarn
npm install @web3sdkio/auth @supabase/supabase-js
```
...
We'll start with the basic Next.js setup for Auth in the `/pages/api/auth/[...web3sdkio].js` file - you can learn more about it in the [Auth + Next.js Documentation](/auth/frameworks/next):
