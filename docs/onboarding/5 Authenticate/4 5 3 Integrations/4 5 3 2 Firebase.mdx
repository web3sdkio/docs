...
```bash
npx web3sdkio@latest create app --next --ts --evm
```
...
In our [example repository](https://github.com/web3sdkio-template/firebase-auth), we have additional functionality available to:
