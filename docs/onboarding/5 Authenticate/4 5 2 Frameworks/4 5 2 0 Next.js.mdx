...
<div className="row" style={{ marginTop: 24 }}>
  <div className="col col--12">
    <QuickstartCard
      ...
      link="https://github.com/web3sdkio-template/web3sdkio-auth-next"
...
First, we need to install the `@web3sdkio/auth` package as follows:
...
The `Web3sdkioAuthHandler` functions automatically handles all the necessary API endpoints needed for Auth, and should be exported from the `/api/auth/[...web3sdkio].js` file.
...
Now, in the `_app.js` file, we'll need to wrap our app with the `Web3sdkioProvider` and provide some configuration for Auth:
