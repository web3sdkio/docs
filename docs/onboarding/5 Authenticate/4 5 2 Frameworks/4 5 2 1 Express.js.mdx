...
<div className="row" style={{ marginTop: 24 }}>
  <div className="col col--12">
    <QuickstartCard
      ...
      description="Implement web3sdkio Auth with Express"
...
We can do this by passing our Express app into the `Web3sdkioAuth` function, which will configure all the endpoints we need:
...
```js
import { getUser } from "@web3sdkio/auth/express";
