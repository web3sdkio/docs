...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/sign-in-with-solana-authenticate-users-with-their-phantom-wallet/"
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdk.io/guides/create-an-nft-gated-site-on-solana/"
      image="/assets/icons/education.png"
    />
  </div>
</div>
...
<div className="row" style={{ marginTop: 24 }}>
  <div className="col col--12" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://github.com/web3sdkio-template/web3sdkio-auth-solana-next"
...
```
WEB3SDKIO_AUTH_PRIVATE_KEY=your-private-key-here
```
...
We can setup all the necessary endpoints by creating a `/pages/api/auth/[...web3sdkio].js` file:

```javascript file=/pages/api/auth/[...web3sdkio].js
...
Here, we configure Auth with the `Web3sdkioAuth` function, passing in our private key and domain (used to prevent phishing attacks).
...
### Web3sdkioAuthHandler

The `Web3sdkioAuthHandler` functions automatically handle all the necessary API endpoints needed for Auth, and should be exported from the `/api/auth/[...web3sdkio].js` file.
...
import { getUser } from "/pages/api/auth/[...web3sdkio]";
...
First, we'll need to install the `@web3sdkio/react` package:

```bash npm2yarn
npm install @web3sdkio/react ethers
```

Now, in the `_app.js` file, we'll need to wrap our app with the `Web3sdkioProvider` and provide some configuration for Solana + Auth:
