...
We'll start by cloning the [Web3sdkio Auth Next](https://github.com/web3sdkio-example/web3sdkio-auth-next) example project using the [web3sdkio CLI](/cli)
...
<div className="row" style={{ marginTop: 24 }}>
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://github.com/web3sdkio-example/nft-gated-website"
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://github.com/web3sdkio-example/web3sdkio-stripe"
