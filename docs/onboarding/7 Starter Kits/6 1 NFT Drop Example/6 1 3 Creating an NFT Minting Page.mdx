...
You can create a copy of this [template repository](https://github.com/web3sdkio-template/custom-minting-page)
by using our CLI or downloading the repository as a `.zip` file and unzipping it from the GitHub URL.

```bash
npx web3sdkio@latest create --template nft-drop
```
...
For any questions or suggestions, join our discord at https://discord.gg/n33UhsfUKB.
