...
[Batch Upload](https://docs.web3sdk.io/pre-built-contracts/nft-drop#lazy-minting-your-nfts) feature.
...
At this point, you'll be given the option to add a [Delayed Reveal](https://docs.web3sdk.io/guides/nft-drop-with-delayed-reveal),
