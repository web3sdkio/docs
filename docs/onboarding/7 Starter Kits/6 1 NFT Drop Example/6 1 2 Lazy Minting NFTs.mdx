...
[Batch Upload](https://portal.web3sdk.io/pre-built-contracts/nft-drop#lazy-minting-your-nfts) feature.

To get started, you can use our example `.csv` or `.json` file:

- [Example CSV File](https://web3sdk.io/example.csv)
- [Example JSON File](https://nightly.web3sdk.io/example.json)
...
At this point, you'll be given the option to add a [Delayed Reveal](https://portal.web3sdk.io/guides/nft-drop-with-delayed-reveal),
