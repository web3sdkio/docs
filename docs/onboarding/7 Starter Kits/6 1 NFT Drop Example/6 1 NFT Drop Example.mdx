...
You can test out the demo deployment here: https://custom-minting-page.web3sdkio-template.com

## Process

We'll run you through the process of:

1. creating your NFTs using our [NFT Drop contract](https://portal.web3sdk.io/pre-built-contracts/nft-drop) and configuring your [claim phases](https://portal.web3sdk.io/pre-built-contracts/nft-drop#setting-claim-phases).
