...
1. creating your NFTs using our [NFT Drop contract](https://docs.web3sdk.io/pre-built-contracts/nft-drop) and configuring your [claim phases](https://docs.web3sdk.io/pre-built-contracts/nft-drop#setting-claim-phases).
