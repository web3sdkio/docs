...
- Deploy the contract to a test network, and set up our [claim phases](https://docs.web3sdk.io/pre-built-contracts/nft-drop#setting-claim-phases).

## Creating an NFT Drop Contract

To create an [NFT Drop](https://docs.web3sdk.io/pre-built-contracts/nft-drop) contract,
...
[Royalty fees](https://docs.web3sdk.io/pre-built-contracts/nft-drop#setting-royalty-fees) in the settings before you deploy your NFT Drop.
...
[How web3sdkio prebuilt contracts work](https://docs.web3sdk.io/pre-built-contracts#how-web3sdkio-pre-built-contracts-work).

## Configuring Claim Phases

[Claim Phases](https://docs.web3sdk.io/pre-built-contracts/nft-drop#setting-claim-phases) are conditions
