...
- Deploy the contract to a test network, and set up our [claim phases](https://portal.web3sdk.io/pre-built-contracts/nft-drop#setting-claim-phases).

## Creating an NFT Drop Contract

To create an [NFT Drop](https://portal.web3sdk.io/pre-built-contracts/nft-drop) contract,
...
[Royalty fees](https://portal.web3sdk.io/pre-built-contracts/nft-drop#setting-royalty-fees) in the settings before you deploy your NFT Drop.
...
[Claim Phases](https://portal.web3sdk.io/pre-built-contracts/nft-drop#setting-claim-phases) are conditions
