...
You can learn more about the difference on the [**Creating Listings**](https://portal.web3sdk.io/pre-built-contracts/marketplace#creating-listings)
...
```bash
npx web3sdkio create --template marketplace-next-ts
```
