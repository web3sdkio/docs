...
- Deploy the contract to a test network, and set up our [claim phases](https://portal.web3sdk.io/pre-built-contracts/edition-drop#setting-claim-phases).

## Creating an Edition Drop Contract

To create an [Edition Drop](https://portal.web3sdk.io/pre-built-contracts/edition-drop) contract,
