...
- Deploy the contract to a test network, and set up our [claim phases](https://docs.web3sdk.io/pre-built-contracts/edition-drop#setting-claim-phases).

## Creating an Edition Drop Contract

To create an [Edition Drop](https://docs.web3sdk.io/pre-built-contracts/edition-drop) contract,
