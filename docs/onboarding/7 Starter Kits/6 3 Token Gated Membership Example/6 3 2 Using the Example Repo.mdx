...
You can create your copy of this [template repository](https://github.com/web3sdkio-template/nft-gated-website)
by using the web3sdkio CLI, or downloading the repository as a `.zip` file and unzipping it from the GitHub URL.

```bash
npx web3sdkio@latest create --template nft-gated-website
```
