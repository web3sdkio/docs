...
<div>
<p>web3sdkio is a development framework that allows you to build web3 functionality into your applications.</p>
...
<div className="heroGrid">
  ...
  <div>
    <p>
      Each contract you deploy comes with a <a href='https://web3sdk.io/dashboard'>dashboard</a> to manage your applications.
    </p>
