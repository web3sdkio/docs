...
The [Dashboard](https://web3sdk.io/dashboard) is a central place for you to create, manage, and interact with your smart contracts.

It allows you to deploy all of our [prebuilt contracts](/pre-built-contracts) to any of our [supported networks](https://blog.web3sdk.io/guides/which-network-should-you-use),
...
For each contract you deploy using the [dashboard](https://web3sdk.io/dashboard) or the [CLI](/cli),
