...
): import("@web3sdkio/sdk").TokenDrop | undefined;
```
...
| --------------- | ------------------------------------------------------- | ------------------------------------------------------------------------ |
| contractAddress | [RequiredParam](./react.requiredparam.md)&lt;string&gt; | the address of the Token Drop contract, found in your web3sdkio dashboard |
