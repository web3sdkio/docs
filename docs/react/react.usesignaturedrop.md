...
): import("@web3sdkio/sdk").SignatureDrop | undefined;
```
...
| --------------- | ------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| contractAddress | [RequiredParam](./react.requiredparam.md)&lt;string&gt; | <i>(Optional)</i> the address of the NFT Drop contract, found in your web3sdkio dashboard |
