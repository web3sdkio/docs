...
): import("@web3sdkio/sdk").Marketplace | undefined;
```
...
| --------------- | ------------------------------------------------------- | ------------------------------------------------------------------------- |
| contractAddress | [RequiredParam](./react.requiredparam.md)&lt;string&gt; | the address of the Marketplace contract, found in your web3sdkio dashboard |
