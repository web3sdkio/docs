...
```jsx
import { useProgram, useMintToken } from "@web3sdkio/react/solana";
...
import("@tanstack/react-query").UseMutationResult&lt;import("@web3sdkio/sdk/solana").TransactionResult, unknown, TokenParams, unknown&gt;
