...
): import("@web3sdkio/sdk").Token | undefined;
```
...
| --------------- | ------------------------------------------------------- | ------------------------------------------------------------------- |
| contractAddress | [RequiredParam](./react.requiredparam.md)&lt;string&gt; | the address of the Token contract, found in your web3sdkio dashboard |
