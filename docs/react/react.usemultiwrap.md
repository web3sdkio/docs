...
): import("@web3sdkio/sdk").Multiwrap | undefined;
```
...
| --------------- | ------------------------------------------------------- | ----------------------------------------------------------------------- |
| contractAddress | [RequiredParam](./react.requiredparam.md)&lt;string&gt; | the address of the Multiwrap contract, found in your web3sdkio dashboard |
