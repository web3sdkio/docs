...
export default function Web3sdkioFeatureCodeSnippet({
  featureName,
  languageFunctionMapping,
  showHr = true,
}: Props) {
  ...
  return (
    <>
      <Tabs groupId={"web3sdkio-code-snippet"} defaultValue={"react"}>
            ...
            return (
              ...
              >
                <CodeBlock language={"text"}>
                  ...
                  Reach out on{" "}
                  <a href={"https://discord.com/invite/web3sdkio"}>Discord</a>{" "}
