...
const contractTypeToLinkMapping = {
  "nft-drop": "https://web3sdk.io/deployer.web3sdkio.eth/DropERC721",
  "nft-collection": "https://web3sdk.io/deployer.web3sdkio.eth/TokenERC721",
  "edition-drop": "https://web3sdk.io/deployer.web3sdkio.eth/DropERC1155",
  pack: "https://web3sdk.io/deployer.web3sdkio.eth/Pack",
  multiwrap: "https://web3sdk.io/deployer.web3sdkio.eth/Multiwrap",
  "signature-drop": "https://web3sdk.io/deployer.web3sdkio.eth/SignatureDrop",
  edition: "https://web3sdk.io/deployer.web3sdkio.eth/TokenERC1155",
  marketplace: "https://web3sdk.io/deployer.web3sdkio.eth/Marketplace",
  token: "https://web3sdk.io/deployer.web3sdkio.eth/TokenERC20",
  "token-drop": "https://web3sdk.io/deployer.web3sdkio.eth/DropERC20",
  vote: "https://web3sdk.io/deployer.web3sdkio.eth/VoteERC20",
...
export default function DeployThisContractButton({
  ...
  return (
    ...
    >
      <img
        src={"/assets/icons/web3sdkio-icon.png"}
        style={{
